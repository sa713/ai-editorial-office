...
Stage 5 is active. S5.R1 is `Done`; S5.R2 is `Review`. S5.R3 through
...
| S5.R2 | Evaluation Signals | Improve how the office recognizes quality, risk, and release health. | Evaluation Signals release candidate is ready for Project Lead review. | The release provides useful evaluation signals without replacing human review or Project Lead acceptance. | Review |
