...
- Current working artifact: `../../research/engineering_review_release_report.md`
- Latest relevant handoff: `handoff-release-writer-agent-to-review-agent.md`
- Next required action: final validation, commit, and deliver release summary
...
| `../../research/engineering_review_competency_landscape.md` | yes | required | Research |
| `../../research/engineering_review_architecture_synthesis.md` | yes | required | Architecture synthesis |
| `../../kb/engineering_review.md` | yes | conditional | Canonical capability doc |
| `../../research/engineering_review_release_report.md` | yes | required | Release report |
...
- None blocking. The checked-in `ROADMAP.md` does not literally name
  Professional Competency Model or Engineering Review; current user mission is
  treated as the explicit stage selector.
