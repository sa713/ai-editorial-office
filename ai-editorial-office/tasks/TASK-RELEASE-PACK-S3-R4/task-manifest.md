...
- Task title: Release Pack Standard And S3.R4 Pack
...
- Next required action: commit and deliver summary
...
| `../../templates/release-pack.md` | yes | required | Release Pack template |
| `../../releases/S3-R4/release-pack.md` | yes | required | First release pack |
...
- Do not modify architecture, AGENTS, ROADMAP, BACKLOG, capabilities,
  lifecycle, pipelines, or roles.
- Do not touch `/Users/sa/Documents/codex/redaction`.
- Keep release pack compact and Project Lead oriented.
- Do not copy the full Professional Analysis release report.
